...
const SocialProofSection = () => {
  return (
    <section id="validacao" className="relative pt-8 md:pt-12 pb-14 md:pb-20 z-10">
              ...
              <thead>
                <tr>
                  ...
                  <th className="px-6 pt-6 pb-4 text-center w-[200px]" style={{ background: "hsl(var(--background))" }}>
                    ...
                    <br />
                    <span className="text-[13px] font-mono text-muted-foreground/60">(Pesquisa Manual)</span>
                  </th>
                </tr>
              </thead>
