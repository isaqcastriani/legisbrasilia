...
const FooterSection = () => {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <motion.h2
                ...
                className="font-heading text-3xl md:text-[2.75rem] lg:text-[3.25rem] font-bold text-foreground leading-[1.08] mb-6"
              >
      ...
      {/* Footer — Humble style: dark bg, logo left, links right */}
      <footer className="relative border-t" style={{ borderColor: "hsl(var(--border) / 0.15)" }}>
        <div className="max-w-[1200px] mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-start justify-between gap-10">
            {/* Left — Logo + tagline */}
            <div>
              <img src={logo} alt="LegisBrasil.IA" className="h-7 w-auto opacity-60 mb-4" />
              <p className="font-heading text-lg md:text-xl font-bold text-foreground leading-tight max-w-xs">
                A Única IA Jurídica 100% Brasileira e{" "}
                <span className="text-primary/60">Validada por Especialistas</span>.
              </p>
            </div>
            ...
            <div className="flex gap-16">
              <div>
                <p className="text-xs font-medium text-muted-foreground/60 mb-4 tracking-wide uppercase">Plataforma</p>
                <div className="space-y-3">
                  <a href="#especialistas" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Especialistas</a>
                  <a href="#diferenciais" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Diferenciais</a>
                  <a href="#validacao" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Validação</a>
                </div>
              </div>
              <div>
                <p className="text-xs font-medium text-muted-foreground/60 mb-4 tracking-wide uppercase">Legal</p>
                <div className="space-y-3">
                  <a href="#" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">Termos</a>
          ...
          {/* Bottom bar */}
          <div className="mt-12 pt-6 border-t flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderColor: "hsl(var(--border) / 0.1)" }}>
